...
- (void) onFsStat: (NSString *) path forFile:(NSString *)file forCbIdx: (NSNumber *)cbIdx;
- (void) onFsFileExists: (NSString *) path forFile:(NSString *)file forCbIdx: (NSNumber *)cbIdx;
...
- (void) onFsWrite: (uint64_t) fd forBuffer: (uint8_t *)buffer forOffset: (int64_t)offset forLength: (uint32_t)length forPosition: (int64_t)position forCbIdx: (NSNumber *)cbIdx;
